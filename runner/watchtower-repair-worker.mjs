...
function repairPrompt(repairCase, task) {
  return [
    ...
    "Do not run npm, package-manager, build, or test commands inside the sandbox. The worker runs fixed validations outside the sandbox after your edit.",
    "Return tests_run as an empty array and note that validation is delegated to the worker.",
    "Do not commit, push, open a pull request, deploy, or mutate data; the worker owns the local commit and the separate shipping gate.",
